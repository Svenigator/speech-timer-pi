...
```bash
# Pi-App-Inhalte nach /home/pi/speech-timer-pi kopieren
# (Nicht den Repo-Root, sondern den Inhalt von pi-app/)
cp -r pi-app/. /home/pi/speech-timer-pi/

cd /home/pi/speech-timer-pi
